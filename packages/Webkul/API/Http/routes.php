...
Route::group(['prefix' => 'api'], function ($router) {
    ...
    Route::group(['namespace' => 'Webkul\API\Http\Controllers\Shop', 'middleware' => ['locale', 'theme', 'currency']], function ($router) {
        ...
        Route::get('categories/slug/{slug}', 'ResourceController@getbyslug')->defaults('_config', [
            'repository' => 'Webkul\Category\Repositories\CategoryRepository',
            'resource' => 'Webkul\API\Http\Resources\Catalog\Category'
        ]);

        Route::get('categoriestree', 'ResourceController@getCategoryTree')->defaults('_config', [
            'repository' => 'Webkul\Category\Repositories\CategoryRepository',
            'resource' => 'Webkul\API\Http\Resources\Catalog\Category'
        ]);
        ...
        Route::get('top-sales-products', 'MyController@getTopSellingProducts')->defaults('_config', [
            'repository' => 'Webkul\Sales\Repositories\OrderItemRepository',
        ]);
        ...
        Route::get('reviews/delete/{id}', 'ResourceController@destroy')->defaults('_config', [
            'repository' => 'Webkul\Product\Repositories\ProductReviewRepository',
            'resource' => 'Webkul\API\Http\Resources\Catalog\ProductReview',
        ...
        Route::get('customer/check', 'SessionController@checkauth');
        ...
        Route::group(['prefix' => 'checkout'], function ($router) {
            ...
            Route::get('cart/coupon', 'CartController@removeCoupon');
