...
Route::group(['middleware' => ['web']], function () {
    Route::prefix('admin')->group(function () {
        ...
        // Route::group(['middleware' => ['admin']], function () {
            ...
            Route::get('top', 'Webkul\Admin\Http\Controllers\DashboardController@getTopSellingProducts');
            ...
            Route::prefix('catalog')->group(function () {
                ...
                Route::get('/attributes/kkk', 'Webkul\Attribute\Http\Controllers\AttributeController@store2');
